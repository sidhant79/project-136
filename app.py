...
def save():
    ...
    f= open("C:/WhiteHat jr/Projects/Project 136/PRO-C136-Project-Boilerplate-main/PRO-C136-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv", "a")
    f.write(data_entry)
